...
def QQMusicSign(param):
    ...
    return execjs.compile(open(os.path.join(_NODE_DIR, "QQSign.js"), "r", encoding="utf-8").read()).call("get_sign", param)
...
class MusicApi_kuwo_sign:
    def __init__(self):
        with open(os.path.join(_NODE_DIR, 'kuwo.js'), 'r', encoding='utf-8') as f:
            js = f.read()
